...
<div class="card mt-3 mb-3">
    <p class="card-body mt-3">If you want to peruse the woefully unfinished code, you can find this project <a href="https://github.com/geekkid1/demoqt">here</a>. It's also linked on my repositories page which you can access via the top navigation bar.</p>
</div>

The technical layout is simple. A simple web-server and a [free API that can return wait times from dozens of rides](https://queue-times.com/pages/api) come together to make a simple application that can access these wait times. But the progression of views to make it a game or quiz that obfuscates the answer is complicated enough to escape the confines of my free time. So it remains unfinished, despite how simple it might be for everything to come together.
